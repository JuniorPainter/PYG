...
import org.apache.hadoop.hbase.client.{Admin, Connection, ConnectionFactory, Delete, Get, Put, Result, Table}
...
object HBaseUtil {
  ...
  //设置属性
  configuration.set("hbase.zookeeper.quorum", GlobalConfig.hbaseZookeeper)
